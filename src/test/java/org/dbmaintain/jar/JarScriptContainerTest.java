...
public class JarScriptContainerTest {
    ...
    public void init() throws IOException {
        Script script1 = new Script("folder1/script1.sql", 1222632047999L, new ScriptContentHandle.StringScriptContentHandle("Script 1 content", "ISO-8859-1"), "@", false);
        Script script2 = new Script("folder1/script2.sql", 1222632047407L, new ScriptContentHandle.StringScriptContentHandle("Script 2 content", "ISO-8859-1"), "@", false);
        scripts = Arrays.asList(script1, script2);
        
        jarFile = File.createTempFile("scriptjar", "jar");
    }
    
    @Test
    public void writeToJarThenReareadFromJarAndEnsureContentIsEqual() throws IOException {
        JarScriptContainer originalScriptJar = new JarScriptContainer(scripts, "@", "postprocessing", "ISO-8859-1");
