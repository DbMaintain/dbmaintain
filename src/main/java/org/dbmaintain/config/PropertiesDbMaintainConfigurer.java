...
import static org.dbmaintain.config.DbMaintainProperties.PROPERTY_AUTO_CREATE_EXECUTED_SCRIPTS_TABLE;
...
import static org.dbmaintain.config.DbMaintainProperties.PROPERTY_SCRIPT_VERSION_COLUMN_NAME;
import static org.dbmaintain.config.DbMaintainProperties.PROPERTY_SCRIPT_VERSION_COLUMN_SIZE;
...
import static org.dbmaintain.config.DbMaintainProperties.PROPKEY_SCRIPTS_ENCODING;
import static org.dbmaintain.config.DbMaintainProperties.PROPKEY_SCRIPTS_TARGETDATABASE_PREFIX;
...
public class PropertiesDbMaintainConfigurer {
    ...
    public ScriptRunner createScriptRunner() {
        ...
        ScriptRunner scriptRunner = ReflectionUtils.createInstanceOfType(clazz, false,
    ...
    public ScriptParserFactory createScriptParserFactory() {
        ...
        ScriptParserFactory scriptParserFactory = ReflectionUtils.createInstanceOfType(clazz, false,
                new Class<?>[] {Map.class, boolean.class}, 
                new Object[] {databaseDialectScriptParserClassMap, backSlashEscapingEnabled});
        
        return scriptParserFactory;
    }
    ...
    public ScriptSource createScriptSource() {
        ...
        ScriptSource scriptSource = ReflectionUtils.createInstanceOfType(clazz, false,
                new Class<?>[] {Set.class, boolean.class, Set.class}, 
                new Object[] {scriptContainers, useScriptFileLastModificationDates, scriptFileExtensions});
        return scriptSource;
    }
    ...
    public JarScriptContainer createJarScriptContainer(List<Script> scripts) {
        ...
        String scriptEncoding = PropertyUtils.getString(PROPKEY_SCRIPTS_ENCODING, configuration);
        return new JarScriptContainer(scripts, targetDatabasePrefix, postProcessingScriptDirName, scriptEncoding);
    }
    ...
    public ScriptContainer createScriptContainer(String scriptLocation) {
        if (scriptLocation.endsWith(".jar")) {
            ...
            Set<String> defaultScriptFileExtensions = new HashSet<String>(PropertyUtils.getStringList(PROPKEY_SCRIPT_EXTENSIONS, configuration));
            String defaultTargetDatabasePrefix = PropertyUtils.getString(PROPKEY_SCRIPTS_TARGETDATABASE_PREFIX, configuration);
            String defaultPostProcessingScriptDirName = PropertyUtils.getString(PROPKEY_POSTPROCESSINGSCRIPTS_DIRNAME, configuration);
            String defaultScriptEncoding = PropertyUtils.getString(PROPKEY_SCRIPTS_ENCODING, configuration);
            
            return new FileScriptContainer(new File(scriptLocation), defaultScriptFileExtensions, 
                    defaultTargetDatabasePrefix, defaultPostProcessingScriptDirName, defaultScriptEncoding);
        }
    }
    ...
    public ExecutedScriptInfoSource createExecutedScriptInfoSource() {
        ...
        String executedScriptsTableName = getDefaultDbSupport().toCorrectCaseIdentifier(
        ...
        ExecutedScriptInfoSource executedScriptInfoSource = ReflectionUtils.createInstanceOfType(clazz, false,
                new Class<?>[] {boolean.class, String.class, String.class, int.class, 
                    String.class, int.class, String.class, String.class, int.class, 
                    String.class, int.class, String.class, DateFormat.class, DbSupport.class, 
                    SQLHandler.class, String.class}, 
                new Object[] {autoCreateVersionTable, executedScriptsTableName, fileNameColumnName, fileNameColumnSize, 
                    ...
                    sqlHandler, targetDatabasePrefix});
        return executedScriptInfoSource;
    }
    ...
    public DBClearer createDbClearer() {
        ...
        DBClearer dbClearer = ReflectionUtils.createInstanceOfType(clazz, false,
