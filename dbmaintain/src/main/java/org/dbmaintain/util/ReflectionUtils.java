...
public class ReflectionUtils {
     ...
     * @throws DbMaintainException if the field could not be accessed
     */
    @SuppressWarnings("unchecked")
    public static <T> T getFieldValue(Object object, Field field) {
        try {
            ...
            throw new DbMaintainException("Error while trying to access field " + field, e);
    ...
    public static void setFieldValue(Object object, Field field, Object value) {
        try {
            ...
            throw new DbMaintainException("Unable to assign the value to field: " + field.getName() + ". Ensure that this field is of the correct type.", e);
    ...
    public static void setFieldAndSetterValue(Object object, Set<Field> fields, Set<Method> setterMethods, Object value) {
        ...
        for (Method method : setterMethods) {
            if (!isSetter(method)) {
                throw new DbMaintainException("Method " + method.getName() + " is expected to be a setter method, but is not.");
            }
            try {
                invokeMethod(object, method, value);

            } catch (DbMaintainException e) {
                throw new DbMaintainException("Unable to invoke method: " + object.getClass().getSimpleName() + "." + method.getName() + ". Ensure that " +
                        "this method has following signature: void myMethod(ValueType value).", e);
            } catch (InvocationTargetException e) {
                throw new DbMaintainException("Unable to invoke method: " + object.getClass().getSimpleName() + "." + method.getName() + ". Method " +
     ...
     * @throws DbMaintainException          if the method could not be invoked
    ...
    public static <T> T invokeMethod(Object target, Method method, Object... arguments) throws InvocationTargetException {
        try {
            ...
            throw new DbMaintainException("Unable to invoke method. Unexpected return type " + method, e);

        } catch (IllegalArgumentException e) {
            throw new DbMaintainException("Error while invoking method " + method, e);
     ...
     * @param arguments The method arguments
     * @return The result of the invocation, null if void
     * @throws DbMaintainException if the method could not be invoked, or the called method throwed an exception
     */
    @SuppressWarnings("unchecked")
     ...
     * @throws DbMaintainException if no value could be found with the given name
     */
    public static <T extends Enum<?>> T getEnumValue(Class<T> enumClass, String enumValueName) {
        ...
        throw new DbMaintainException("Unable to find a enum value in enum: " + enumClass + ", with value name: " + enumValueName);
    }
    ...
    public static String getPropertyName(Method setterMethod) {
        ...
        if (methodName.length() < 4 || !methodName.startsWith("set")) {
            throw new DbMaintainException("Unable to get field name for setter method " + setterMethod);
        }
