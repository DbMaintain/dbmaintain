 ...
 * start of a stored procedure for a specific SQL dialect.
 *
 * @author Filip Neven
 * @author Tim Ducheyne
 */
public interface StoredProcedureMatcher {

    /**
     * Returns whether the given string is the start of a stored procedure definition.
     ...
     *
     * @param statementWithoutCommentsOrWhitespace the start of an SQL statement
