...
public class Oracle10DbSupport extends OracleDbSupport {
     ...
     */
    public Oracle10DbSupport(DatabaseInfo databaseInfo, DataSource dataSource, SQLHandler sqlHandler, String customIdentifierQuoteString, StoredIdentifierCase customStoredIdentifierCase) {
