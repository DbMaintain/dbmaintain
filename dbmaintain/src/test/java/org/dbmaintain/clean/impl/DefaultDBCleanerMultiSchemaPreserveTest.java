...
public class DefaultDBCleanerMultiSchemaPreserveTest {
    ...
    public void setUp() throws Exception {
        // configure 3 schemas
        dbSupports = TestUtils.getDbSupports("PUBLIC", "SCHEMA_A", "\"SCHEMA_B\"", "schema_c");
        ...
        // items to preserve
        DbItemIdentifier schemaC = parseSchemaIdentifier("schema_c", dbSupports);
        DbItemIdentifier tableTest = parseItemIdentifier(TABLE, "test", dbSupports);
