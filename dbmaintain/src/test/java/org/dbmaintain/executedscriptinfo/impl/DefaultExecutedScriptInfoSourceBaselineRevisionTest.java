...
public class DefaultExecutedScriptInfoSourceBaselineRevisionTest {
    ...
    public void initialize() throws Exception {
        ...
        executedScriptInfoSource = getDefaultExecutedScriptInfoSource(defaultDbSupport, true);
    ...
    public void someScriptsFiltered() throws Exception {
        executedScriptInfoSource = getDefaultExecutedScriptInfoSource(defaultDbSupport, false, new ScriptIndexes("1.2"));
    ...
    public void allScriptsFiltered() throws Exception {
        executedScriptInfoSource = getDefaultExecutedScriptInfoSource(defaultDbSupport, false, new ScriptIndexes("999"));
    ...
    public void noScriptsFiltered() throws Exception {
        executedScriptInfoSource = getDefaultExecutedScriptInfoSource(defaultDbSupport, false, new ScriptIndexes("1.0"));
